  ...
  const OrderDetailDialog = () => (
    ...
    >
      ...
      <DialogActions sx={{ p: 3, bgcolor: "#f8f9fa" }}>
        <Button onClick={() => setOpenOrderDetail(false)}>Đóng</Button>
  ...
  return (
    <Box>
      ...
      <Box sx={{ mb: 4 }}>
        <Typography
          variant="h4"
          sx={{ fontWeight: 800, color: "#2c3e50", mb: 1 }}
        >
          Quản lý đơn hàng
        </Typography>
                    ...
                    <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
                      ...
                      <IconButton
                        ...
                        sx={{
                          p: 0.5,
                          color:
                            sortBy === "totalAmount" ? "#667eea" : "inherit",
                        }}
                      >
                          ...
                          {order.status.toUpperCase() === "PENDING" && (
                            <Tooltip title="Duyệt đơn hàng">
                              <IconButton
                                ...
                                sx={{ color: "#4CAF50" }}
                                onClick={() =>
                                  handleApproveOrder(order.orderId)
                                }
                              >
                                <CheckCircle />
                              </IconButton>
